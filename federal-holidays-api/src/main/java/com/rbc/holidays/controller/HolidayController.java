...
public class HolidayController {
    ...
    /**
     * Retrieves all federal holidays with optional pagination.
     * 
    ...
    public ResponseEntity<List<HolidayResponse>> getAllHolidays(
        ...
        logger.debug("Fetching all holidays with offset: {}, limit: {}", offset, limit);
        List<HolidayResponse> response = holidayService.getAllHolidays(offset, limit);
