...
class HolidayControllerTest {
    ...
    @Test
    void getAllHolidaysShouldReturnOkResponseWithDefaultPagination() {
        List<HolidayResponse> response = List.of(
                new HolidayResponse(1L, "Independence Day", LocalDate.of(2026, 7, 4), "USA", true, "Holiday")
        );
        when(holidayService.getAllHolidays(0, 100)).thenReturn(response);

        var entity = controller.getAllHolidays(0, 100);
    ...
    void uploadHolidaysShouldReturnOkResponse() {
        ...
        FileUploadResponse response = new FileUploadResponse(1, 1, List.of());
